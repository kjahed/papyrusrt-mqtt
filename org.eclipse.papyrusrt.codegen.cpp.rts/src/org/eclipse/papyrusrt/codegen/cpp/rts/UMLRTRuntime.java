...
public final class UMLRTRuntime {
	...
	private static final ExternalHeaderFile umlrtmqttprotocol_hh = new ExternalHeaderFile("umlrtmqttprotocol.hh");
	private static final ExternalHeaderFile umlrtmqttproxycapsule_hh = new ExternalHeaderFile("umlrtmqttproxycapsule.hh");
	...
	public static class UMLRTMQTTProxyCapsule {
		public static final ExternalElement Element = new ExternalFwdDeclarable(umlrtmqttproxycapsule_hh, "Capsule_MQTTProxyCapsule", "class Capsule_MQTTProxyCapsule");
	...
	public static class UMLRTMQTTProtocol {
		public static final ExternalElement Element = new ExternalFwdDeclarable(umlrtmqttprotocol_hh, "UMLRTMQTTProtocol", "class UMLRTMQTTProtocol");
		public static final ExternalElement BaseRole = new ExternalFwdDeclarable(umlrtmqttprotocol_hh, "UMLRTMQTTProtocol_baserole", "class UMLRTMQTTProtocol_baserole");
		public static final ExternalElement ReceivedSignal = new ExternalElement(umlrtmqttprotocol_hh, "signal_received");
		public static final ExternalElement ConnectedSignal = new ExternalElement(umlrtmqttprotocol_hh, "signal_connected");
		public static final ExternalElement DisconnectedSignal = new ExternalElement(umlrtmqttprotocol_hh, "signal_disconnected");
		public static final ExternalElement ErrorSignal = new ExternalElement(umlrtmqttprotocol_hh, "signal_error");
	...
	public static Type getSystemProtocolRole(Protocol protocol, boolean baseRole) {
		...
		if (RTSModelLibraryUtils.isMQTTProtocol(protocol))
			return baseRole ? UMLRTMQTTProtocol.getBaseRoleType() : null;
		return null;
	}
	...
	public static boolean needsUMLRTCommsPort(Protocol protocol) {
		...
		if (RTSModelLibraryUtils.isMQTTProtocol(protocol))
			return UMLRTMQTTProtocol.needsUMLRTCommsPort();
		return true;
	}
	...
	public static Expression getSystemProtocolSignalAccess(Signal signal) {
		...
		if (RTSModelLibraryUtils.isMQTTProtocol(protocol))
			return UMLRTMQTTProtocol.Signal(signal);
		return null;
	}
}
