...
public class CapsuleGenerator extends BasicClassGenerator {
	...
	public boolean generate() {
		...
		if (modelSuperClass == null) {
			...
			if(modelSuperClass.getName().equals("MQTTProxyCapsule")) { //TODO: find a better way
				cls.addBase(CppClass.Access.PUBLIC, UMLRTRuntime.UMLRTMQTTProxyCapsule.Element);
			}
			else {
		...
		if (modelSuperClass != null && modelSuperClass.getName().equals("MQTTProxyCapsule")) {
			MemberAccess lhs = new MemberAccess(UMLRTRuntime.UMLRTMQTTProxyCapsule.Element, 
					new MemberField(PrimitiveType.CHAR.const_().ptr(), "Capsule_MQTTProxyCapsule::host"));
			MemberAccess rhs = new MemberAccess(cls, new MemberField(PrimitiveType.CHAR.const_().ptr(), "host"));
			ctor.add(new BinaryOperation(lhs, BinaryOperation.Operator.ASSIGN, rhs));
			
			lhs = new MemberAccess(UMLRTRuntime.UMLRTMQTTProxyCapsule.Element, 
					new MemberField(PrimitiveType.INT, "Capsule_MQTTProxyCapsule::port"));
			rhs = new MemberAccess(cls, new MemberField(PrimitiveType.INT, "port"));
			ctor.add(new BinaryOperation(lhs, BinaryOperation.Operator.ASSIGN, rhs));
			
			lhs = new MemberAccess(UMLRTRuntime.UMLRTMQTTProxyCapsule.Element, 
					new MemberField(PrimitiveType.CHAR.const_().ptr(), "Capsule_MQTTProxyCapsule::username"));
			rhs = new MemberAccess(cls, new MemberField(PrimitiveType.CHAR.const_().ptr(), "username"));
			ctor.add(new BinaryOperation(lhs, BinaryOperation.Operator.ASSIGN, rhs));
			
			lhs = new MemberAccess(UMLRTRuntime.UMLRTMQTTProxyCapsule.Element, 
					new MemberField(PrimitiveType.CHAR.const_().ptr(), "Capsule_MQTTProxyCapsule::password"));
			rhs = new MemberAccess(cls, new MemberField(PrimitiveType.CHAR.const_().ptr(), "password"));
			ctor.add(new BinaryOperation(lhs, BinaryOperation.Operator.ASSIGN, rhs));
			
			lhs = new MemberAccess(UMLRTRuntime.UMLRTMQTTProxyCapsule.Element, 
					new MemberField(PrimitiveType.CHAR.const_().ptr(), "Capsule_MQTTProxyCapsule::topic"));
			rhs = new MemberAccess(cls, new MemberField(PrimitiveType.CHAR.const_().ptr(), "topic"));
			ctor.add(new BinaryOperation(lhs, BinaryOperation.Operator.ASSIGN, rhs));
			
			lhs = new MemberAccess(UMLRTRuntime.UMLRTMQTTProxyCapsule.Element, 
					new MemberField(PrimitiveType.CHAR.const_().ptr(), "Capsule_MQTTProxyCapsule::subscriptions"));
			rhs = new MemberAccess(cls, new MemberField(PrimitiveType.CHAR.const_().ptr(), "subscriptions"));
			ctor.add(new BinaryOperation(lhs, BinaryOperation.Operator.ASSIGN, rhs));
		}
